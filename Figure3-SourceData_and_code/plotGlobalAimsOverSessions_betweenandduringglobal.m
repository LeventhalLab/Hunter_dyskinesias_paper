function plotGlobalAimsOverSessions_betweenandduringglobal(avgAimsData)

% Plots global AIMs over sessions for the between and primary during groups on the same graph 

data = avgAimsData(2).global;
...
%Plots primary during rats 
data = avgAimsData(1).global;
